...
public class StudentRegistry {
    public static void main(String[] args) {
        ...
        student1.setStudentId("45DFGTY");
        student1.setName("martin paul");
        ...
        student2.setStudentId("4567FGH");
        student2.setName("Makani paul");
        ...
        Student higherGrade=compareGrade(student1, student2);
        System.out.println("Student with the higher grade;");
        System.out.println(higherGrade.getName()+ "has the higher grade with " +higherGrade.getGrade() );
        ...
        System.out.println("\nLetter Grades:");
        System.out.println(student1.getName() + "'s letter grade: " + student1.getGrade());
        System.out.println(student2.getName() + "'s letter grade: " + student2.getGrade());;

        
        
        // Step 7: Test the passing status method for both students
        System.out.println("\nif passed:");
        System.out.println(student1.checkIfPass());
        System.out.println(student2.checkIfPass() );
    ...
    public static Student compareGrade(Student  student1, Student student2){
