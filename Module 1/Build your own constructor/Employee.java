...
public class Employee implements Cloneable {
    ...
    public void setAge(int age){
        if (age>18 && age<65) {
            ...
            System.out.println("Age is not in the intervalle");
        }
    ...
    public void setSalary(double salary){
        if (salary>=0) {
            ...
            System.out.println("salary is under than 0");
        }
    }
    ...
    public void giveRaise(double percentage){
        if (percentage>0) {
            double raiseAmout = this.salary * (percentage/100);
            this.salary=raiseAmout;
